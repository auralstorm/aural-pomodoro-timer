...
const achievementIconModules = import.meta.glob("../../../assets/achievements/**/*.png", {
  eager: true,
  import: "default",
  query: "?url",
...
export const achievementConfigs: AchievementConfig[] = achievementBaseConfigs.map((config) => ({
  ...config,
...
function getAchievementIcon(config: AchievementBaseConfig, state: "locked" | "unlocked") {
